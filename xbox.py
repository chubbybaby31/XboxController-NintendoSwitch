...
class Joystick:
    ...
    def __init__(self,refreshRate = 90):
        self.proc = subprocess.Popen(['xboxdrv','--device-by-id','045e:02dd','--type','xbox360-wireless','-l','6','--no-uinput','--detach-kernel-driver'], stdout=subprocess.PIPE, bufsize=0)
